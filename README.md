...
我修改了vm源码, 这样我们使用vm时会少一些检测点. 所以我们是用vm来补环境的. 当然也会有穿透问题, 也需要我们去修改源码来过这个问题
...
- defineIstrusted: 给事件对象添加Istrusted属性的get函数.
    - 示例: my_api.defineIstrusted(event)
...
这个框架是讲课的时候，基于上一版自己写的框架重构优化了。

然后圈内的“王中镇”(他报了课), 直接把代码泄露出去了. 

然而这还不是最糟糕的. 我自己私人仓库写的框架，我拉了几个大佬成为合作者(看代码). 

然后其中一个人, 拿框架跟王中镇换代码了. 

嗯, 然后又泄露发出去了. 

真的是烂人一个, 代码在他手里就是开源. 拿着别人的代码去换自己的人情
